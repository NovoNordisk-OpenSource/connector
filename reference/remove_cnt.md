...
#> {"time":"2026-02-04 13:32:26","type":"write","file":"iris.csv @ /tmp/RtmpNYgVLi/test1dcd357290a1"}

cnt$data |>
  remove_cnt("iris.csv")
#> {"time":"2026-02-04 13:32:26","type":"delete","file":"iris.csv @ /tmp/RtmpNYgVLi/test1dcd357290a1"}
```

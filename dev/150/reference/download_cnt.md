...
#> {"time":"2026-07-03 13:31:35","type":"write","file":"iris.csv @ /tmp/RtmpquOkUg/test1d8e52a7796f"}

cnt$data |>
  download_cnt("iris.csv", tempfile(fileext = ".csv"))
#> {"time":"2026-07-03 13:31:35","type":"read","file":"iris.csv @ /tmp/RtmpquOkUg/test1d8e52a7796f"}
```

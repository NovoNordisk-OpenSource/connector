...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-12 15:39:59","type":"write","file":"iris.csv @ /tmp/Rtmpyx6Z2w/test1d3e5fb0989"}

cnt$data |>
  read_cnt("iris.csv", show_col_types = FALSE) |>
  head()
#> {"time":"2026-03-12 15:39:59","type":"read","file":"iris.csv @ /tmp/Rtmpyx6Z2w/test1d3e5fb0989"}
#> # A tibble: 6 × 5
#>   Sepal.Length Sepal.Width Petal.Length Petal.Width Species
#>          <dbl>       <dbl>        <dbl>       <dbl> <chr>  
#> 1          5.1         3.5          1.4         0.2 setosa 

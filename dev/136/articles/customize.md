...
#> Specifications:
#> • path: /tmp/RtmpgLKRd5/file27e2207fdeeb/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpgLKRd5/file27e2207fdeeb/my_root_path/my_project
#> [1] "my_file.txt"
```

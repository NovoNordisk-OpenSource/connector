...
#> Specifications:
#> • path: /tmp/RtmpvTI7Vg/file28e25cbcb161/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpvTI7Vg/file28e25cbcb161/my_root_path/my_project
#> [1] "my_file.txt"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-04 13:32:23","type":"write","file":"iris.csv @ /tmp/RtmpNYgVLi/test1dcd3fd6084b"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-02-04 13:32:23","type":"read","file":". @ /tmp/RtmpNYgVLi/test1dcd3fd6084b"}
#> [1] "iris.csv"
```

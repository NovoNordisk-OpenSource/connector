...
| `download_cnt()` | `file` | Returns the path to the downloaded file for immediate use |
...
| `download_directory_cnt()` | `dir` | Returns the path to the downloaded directory allowing for immediate use |

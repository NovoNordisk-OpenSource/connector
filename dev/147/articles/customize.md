...
#> Specifications:
#> • path: /tmp/RtmpBlB7vb/file29017f99a3e7/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpBlB7vb/file29017f99a3e7/my_root_path/my_project
#> [1] "my_file.txt"
```

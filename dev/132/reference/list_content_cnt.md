...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-15 18:48:16","type":"write","file":"iris.csv @ /tmp/Rtmptz0BAX/test1ee726bba7f4"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-15 18:48:16","type":"read","file":". @ /tmp/Rtmptz0BAX/test1ee726bba7f4"}
#> [1] "iris.csv"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-23 09:17:02","type":"write","file":"iris.csv @ /tmp/RtmpP1aEE7/test1e054268b13b"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-23 09:17:02","type":"read","file":". @ /tmp/RtmpP1aEE7/test1e054268b13b"}
#> [1] "iris.csv"
```

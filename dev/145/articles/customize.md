...
#> Specifications:
#> • path: /tmp/RtmpQHCYOA/file27d93aa99fd1/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpQHCYOA/file27d93aa99fd1/my_root_path/my_project
#> [1] "my_file.txt"
```

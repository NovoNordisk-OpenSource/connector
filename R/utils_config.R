...
#'
#' This function adds metadata to a YAML configuration file by modifying the provided key-value pair
#'  in the metadata section of the file.
#'
...
#'
#' This function removes metadata from a YAML configuration file by deleting the specified key
#' from the metadata section of the file.
#'
#' @param config_path The file path to the YAML configuration file

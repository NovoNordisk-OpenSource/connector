...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-07-06 10:19:58","type":"write","file":"iris.csv @ /tmp/RtmpRmflYz/test1d6621970b1e"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-07-06 10:19:58","type":"read","file":". @ /tmp/RtmpRmflYz/test1d6621970b1e"}
#> [1] "iris.csv"
```

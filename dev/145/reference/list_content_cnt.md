...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-12 15:39:58","type":"write","file":"iris.csv @ /tmp/Rtmpyx6Z2w/test1d3e3a6ad126"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-12 15:39:58","type":"read","file":". @ /tmp/Rtmpyx6Z2w/test1d3e3a6ad126"}
#> [1] "iris.csv"
```

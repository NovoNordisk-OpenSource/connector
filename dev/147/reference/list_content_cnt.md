...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-23 09:37:52","type":"write","file":"iris.csv @ /tmp/RtmpqehMJz/test1e494dda9856"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-23 09:37:52","type":"read","file":". @ /tmp/RtmpqehMJz/test1e494dda9856"}
#> [1] "iris.csv"
```

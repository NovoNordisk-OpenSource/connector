...
#> Specifications:
#> • path: /tmp/RtmpfWJwg1/file282850a53e3e/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpfWJwg1/file282850a53e3e/my_root_path/my_project
#> [1] "my_file.txt"
```

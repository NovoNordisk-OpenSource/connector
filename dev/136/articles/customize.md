...
#> Specifications:
#> • path: /tmp/Rtmpdhmmp1/file2802685214d7/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/Rtmpdhmmp1/file2802685214d7/my_root_path/my_project
#> [1] "my_file.txt"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-01-05 15:16:31","type":"write","file":"iris.csv @ /tmp/RtmpDZhcXt/test1d50232da622"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-01-05 15:16:31","type":"read","file":". @ /tmp/RtmpDZhcXt/test1d50232da622"}
#> [1] "iris.csv"
```

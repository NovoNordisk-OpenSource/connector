...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-23 09:21:39","type":"write","file":"iris.csv @ /tmp/RtmplxRRSn/test1e3656b757c0"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-23 09:21:39","type":"read","file":". @ /tmp/RtmplxRRSn/test1e3656b757c0"}
#> [1] "iris.csv"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-07-03 13:34:39","type":"write","file":"iris.csv @ /tmp/RtmpauaOls/test1da56e8f081"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-07-03 13:34:39","type":"read","file":". @ /tmp/RtmpauaOls/test1da56e8f081"}
#> [1] "iris.csv"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-15 12:51:11","type":"write","file":"iris.csv @ /tmp/RtmpagAbWU/test1b1c1de319c8"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-15 12:51:11","type":"read","file":". @ /tmp/RtmpagAbWU/test1b1c1de319c8"}
#> [1] "iris.csv"
```

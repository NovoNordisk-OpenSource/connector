...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-02 12:07:15","type":"write","file":"iris.csv @ /tmp/RtmpH9kIBZ/test1dfb7f1d8c5d"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-02-02 12:07:15","type":"read","file":". @ /tmp/RtmpH9kIBZ/test1dfb7f1d8c5d"}
#> [1] "iris.csv"
```

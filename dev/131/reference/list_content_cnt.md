...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-15 12:12:58","type":"write","file":"iris.csv @ /tmp/RtmpJLE7aX/test1f1b553502d6"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-15 12:12:58","type":"read","file":". @ /tmp/RtmpJLE7aX/test1f1b553502d6"}
#> [1] "iris.csv"
```

...
#> Specifications:
#> • path: /tmp/RtmpGnkF85/file28b367ba4b22/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpGnkF85/file28b367ba4b22/my_root_path/my_project
#> [1] "my_file.txt"
```

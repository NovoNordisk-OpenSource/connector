...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-19 15:57:11","type":"write","file":"iris.csv @ /tmp/RtmpMb10rt/test1d447d448163"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-19 15:57:11","type":"read","file":". @ /tmp/RtmpMb10rt/test1d447d448163"}
#> [1] "iris.csv"
```

...
Source:
[`DESCRIPTION`](https://github.com/NovoNordisk-OpenSource/connector/blob/feat/ignore-case-option/DESCRIPTION)

Girard C, Thomsen A, Obucina V (2026). *connector: Streamlining Data
Access in Clinical Research*. R package version 1.0.0.9002,

...
#> Specifications:
#> • path: /tmp/Rtmptty2zS/file25c72e98638a/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/Rtmptty2zS/file25c72e98638a/my_root_path/my_project
#> [1] "my_file.txt"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-07-03 13:31:35","type":"write","file":"iris.csv @ /tmp/RtmpquOkUg/test1d8e4140c248"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-07-03 13:31:35","type":"read","file":". @ /tmp/RtmpquOkUg/test1d8e4140c248"}
#> [1] "iris.csv"
```

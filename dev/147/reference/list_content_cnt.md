...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-23 09:17:46","type":"write","file":"iris.csv @ /tmp/RtmpLNMdiu/test1e66ea8b61e"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-23 09:17:46","type":"read","file":". @ /tmp/RtmpLNMdiu/test1e66ea8b61e"}
#> [1] "iris.csv"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-04 13:02:51","type":"write","file":"iris.csv @ /tmp/Rtmp7x9gw0/test1dd45ae7fc45"}

cnt$data |>
  read_cnt("iris.csv", show_col_types = FALSE) |>
  head()
#> {"time":"2026-02-04 13:02:51","type":"read","file":"iris.csv @ /tmp/Rtmp7x9gw0/test1dd45ae7fc45"}
#> # A tibble: 6 × 5
#>   Sepal.Length Sepal.Width Petal.Length Petal.Width Species
#>          <dbl>       <dbl>        <dbl>       <dbl> <chr>  
#> 1          5.1         3.5          1.4         0.2 setosa 

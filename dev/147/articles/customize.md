...
#> Specifications:
#> • path: /tmp/RtmpxXccdk/file28eb6e8a0115/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpxXccdk/file28eb6e8a0115/my_root_path/my_project
#> [1] "my_file.txt"
```

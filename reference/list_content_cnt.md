...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-03-19 07:34:52","type":"write","file":"iris.csv @ /tmp/RtmpZ5Y7f5/test1f415f94da83"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-03-19 07:34:52","type":"read","file":". @ /tmp/RtmpZ5Y7f5/test1f415f94da83"}
#> [1] "iris.csv"
```

...
The first we name “folder”, specify the type to be
[`connector_fs()`](https://novonordisk-opensource.github.io/connector/reference/connector_fs.md),
and the path to the folder. The second is a database connector to an in
memory SQLite database, that we specify using the
[`connector_dbi()`](https://novonordisk-opensource.github.io/connector/reference/connector_dbi.md)
type, which uses
[`DBI::dbConnect()`](https://dbi.r-dbi.org/reference/dbConnect.html) to
initalize the connection. Therefore we also give the `DBI driver` to
use, and arguments to it.

To connect and create the conenctors we use
...
- [`connect()`](https://novonordisk-opensource.github.io/connector/reference/connect.md)
  for more documentation and how to specify the configuration file
- [`vignette("connector")`](https://novonordisk-opensource.github.io/connector/articles/connector.md)
  for more examples and how to use the package
- [`vignette("customize")`](https://novonordisk-opensource.github.io/connector/articles/customize.md)
  on how to create your own connector and customize behavior
- [`help("connector-options")`](https://novonordisk-opensource.github.io/connector/reference/connector-options.md)
  for all the options available to customize the behavior of `connector`

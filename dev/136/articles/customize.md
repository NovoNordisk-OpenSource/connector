...
#> Specifications:
#> • path: /tmp/RtmppQht0g/file27f1721bd9dc/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmppQht0g/file27f1721bd9dc/my_root_path/my_project
#> [1] "my_file.txt"
```

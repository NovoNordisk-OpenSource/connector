...
#> {"time":"2025-12-17 22:41:16","type":"write","file":"iris.csv @ /tmp/Rtmpz9WGRZ/test1d89377e3bfb"}

cnt$data |>
  download_cnt("iris.csv", tempfile(fileext = ".csv"))
#> {"time":"2025-12-17 22:41:16","type":"read","file":"iris.csv @ /tmp/Rtmpz9WGRZ/test1d89377e3bfb"}
```

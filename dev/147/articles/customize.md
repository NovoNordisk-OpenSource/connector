...
#> Specifications:
#> • path: /tmp/RtmpPo1oyc/file28a54c7918f0/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpPo1oyc/file28a54c7918f0/my_root_path/my_project
#> [1] "my_file.txt"
```

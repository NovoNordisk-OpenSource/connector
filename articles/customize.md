...
#> Specifications:
#> • path: /tmp/RtmpCFdxk7/file29dd3d576a83/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpCFdxk7/file29dd3d576a83/my_root_path/my_project
#> [1] "my_file.txt"
```

...
#> Specifications:
#> • path: /tmp/RtmpkOmjax/file27ea5c3e6bcc/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpkOmjax/file27ea5c3e6bcc/my_root_path/my_project
#> [1] "my_file.txt"
```

...
#> Specifications:
#> • path: /tmp/RtmpASi11c/file29be566d8585/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpASi11c/file29be566d8585/my_root_path/my_project
#> [1] "my_file.txt"
```

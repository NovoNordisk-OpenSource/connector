...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-04 13:02:49","type":"write","file":"iris.csv @ /tmp/Rtmp7x9gw0/test1dd4658bbdc"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-02-04 13:02:49","type":"read","file":". @ /tmp/Rtmp7x9gw0/test1dd4658bbdc"}
#> [1] "iris.csv"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-17 22:41:16","type":"write","file":"iris.csv @ /tmp/Rtmpz9WGRZ/test1d8958b72c4b"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-17 22:41:16","type":"read","file":". @ /tmp/Rtmpz9WGRZ/test1d8958b72c4b"}
#> [1] "iris.csv"
```

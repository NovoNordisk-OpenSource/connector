...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-03 09:57:56","type":"write","file":"iris.csv @ /tmp/RtmpuskfsN/test1dce22873515"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-02-03 09:57:56","type":"read","file":". @ /tmp/RtmpuskfsN/test1dce22873515"}
#> [1] "iris.csv"
```

...
#> Specifications:
#> • path: /tmp/Rtmp3yKAu8/file286f27c2b3c0/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/Rtmp3yKAu8/file286f27c2b3c0/my_root_path/my_project
#> [1] "my_file.txt"
```

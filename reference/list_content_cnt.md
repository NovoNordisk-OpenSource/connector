...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2025-12-16 14:14:55","type":"write","file":"iris.csv @ /tmp/RtmpDbHqZq/test1f17661204a2"}

cnt$data |>
  list_content_cnt()
#> {"time":"2025-12-16 14:14:55","type":"read","file":". @ /tmp/RtmpDbHqZq/test1f17661204a2"}
#> [1] "iris.csv"
```

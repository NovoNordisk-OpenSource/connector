...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-01-05 12:31:01","type":"write","file":"iris.csv @ /tmp/RtmpAUXnEM/test1d571241f4c4"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-01-05 12:31:01","type":"read","file":". @ /tmp/RtmpAUXnEM/test1d571241f4c4"}
#> [1] "iris.csv"
```

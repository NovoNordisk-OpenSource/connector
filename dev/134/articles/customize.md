...
#> Specifications:
#> • path: /tmp/RtmpKmajAn/file282f18887adf/my_root_path/my_project
#> • metadata: <NULL>
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpKmajAn/file282f18887adf/my_root_path/my_project
#> [1] "my_file.txt"
```

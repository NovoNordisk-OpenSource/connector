...
#> {"time":"2026-03-12 15:39:57","type":"write","file":"iris.csv @ /tmp/Rtmpyx6Z2w/test1d3e7cbd4d77"}

cnt$data |>
  download_cnt("iris.csv", tempfile(fileext = ".csv"))
#> {"time":"2026-03-12 15:39:57","type":"read","file":"iris.csv @ /tmp/Rtmpyx6Z2w/test1d3e7cbd4d77"}
```

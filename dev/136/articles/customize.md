...
#> Specifications:
#> • path: /tmp/RtmpF9NifY/file27df4f2867fd/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/RtmpF9NifY/file27df4f2867fd/my_root_path/my_project
#> [1] "my_file.txt"
```

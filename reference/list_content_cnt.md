...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-02-03 10:05:54","type":"write","file":"iris.csv @ /tmp/RtmpRHFAeR/test1e1b417f7414"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-02-03 10:05:54","type":"read","file":". @ /tmp/RtmpRHFAeR/test1e1b417f7414"}
#> [1] "iris.csv"
```

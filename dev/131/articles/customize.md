...
#> Specifications:
#> • path: /tmp/Rtmpq56mxD/file25bd3d57c0f0/my_root_path/my_project
#> • project: my_project
```
...
my_project_extra |>
  list_content_cnt()
#> → Listing content of /tmp/Rtmpq56mxD/file25bd3d57c0f0/my_root_path/my_project
#> [1] "my_file.txt"
```

...
cnt$data |>
  write_cnt(iris, "iris.csv")
#> {"time":"2026-04-08 08:48:03","type":"write","file":"iris.csv @ /tmp/RtmpS7iK5n/test1efc7679c3d8"}

cnt$data |>
  list_content_cnt()
#> {"time":"2026-04-08 08:48:03","type":"read","file":". @ /tmp/RtmpS7iK5n/test1efc7679c3d8"}
#> [1] "iris.csv"
```
